...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>css/registernew.css">
  ...
  <body>
    <div class="container">
      ...
      <div class="row">        
        ...
        <div class="col-md-4 formregister">
          ...
          <?php echo form_open(); ?>
            ...
            <?php echo form_close(); ?>
            <small>back to</small><a href="<?php echo site_url('user/login') ?>">Login &raquo;</a>
          </div>
          <div class="col-md-4">
